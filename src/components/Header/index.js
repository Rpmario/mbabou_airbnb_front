...
function MonComposant() {
  ...
  return (
    <div>
      <button onClick={handleClick}>Afficher la div</button>
      {afficherDiv && <div>Contenu de la div</div>}
    </div>
  );
}
    ...
    <header>
      <div className={styles.header__main}>
        ...
        <div className={styles.header__menu2}>
          ...
          <div className={styles.header__profil} onclick="afficherDiv()">
            <Link href="#" className={styles.header__profilI}>
        ...
        <div className={styles.header__submain1}>
          <div className={styles.header__submain2}>
            <Link href="#" className={styles.header__chevron} >
          ...
          {/* <Button
            title="Filtres"
            className={styles.header__boutton}
          /> */}
